...
EnvJasmine.about = function () {
    ...
    print("     --jsDir=<Dir>               Set root javascript directory for the project");
};
...
EnvJasmine.loadSpecs = function() {
	// Populate the spec files for Jasmine to test
